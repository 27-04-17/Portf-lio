...
const Data = () => {
  return (
    <div className="home__Data">
        <h1 className="home__title">Mayara Santos
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Web Programer</h3>
        <p className="home__description"></p><h5><p>Apenas mais uma Delovoper de plantão </p></h5>
        <p>Sou apaixonada por Tecnológia</p> 
        <p>e muito dedicada aos meus projetos.</p>
