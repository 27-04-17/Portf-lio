...
import "./sobre.css";
import AboutImg from "../../assets/may.jpeg";
    ...
    <section className="about section" id="about">
        ...
        <div className='about__container container grid'>
            ...
            <div className="about__data">
                ...
                <p className="about__description">Desenvolvedora 
                frontend, crio páginas web com interface de usuário 
                UI/UX, estudante da Escola Técnica Estadual (ETEC) 
                de Cotia. </p>
